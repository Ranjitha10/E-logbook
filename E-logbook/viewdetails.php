 ...
 <div class="col_1">
   ...
   <div class="right_section">
      <div class="navigation" id="sssignup">
        ...
        <h3> ENTER USN:<input type="text" name="detail"><br/><br/>
          <input type="submit" value="SUBMIT"></H3>
        </form>

        <!--<p><form action="even.php" method="POST">
          <input type="submit" value="Even Semester">
        </form><br/>
        <form action="odd.php" method="POST">
          <input type="submit" value="Odd semester">
        </form>-->
        </p>
        <br>
        <p></p>
