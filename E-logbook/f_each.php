     ...
     <div class="col_1">
        ...
        <div class="box">
          <ul>
            ...
            <li><a href="facultyreport.php">BACK</a></li>
 ...
 <div class="col_1">
   ...
   <div class="right_section">
      <div class="navigation" id="sssignup">
        <h2>IDIVIDUAL STUDENT</h2>
        <hr>
        <p>
          
            <!--<center><h3>ENTER USN</H3></center><br/>-->
            <form action="f_each1.php" method="POST">
       <H4> ENTER USN:<input type="text" name="usn" class="textfield"></H4>
