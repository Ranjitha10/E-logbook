 ...
 <div class="col_1">
    ...
    <div class="right_section">
      <div class="navigation" id="sssignup">
        ...
        <hr>
        <p>
<form method="post" action="studentlogin1.php">
<h3>Username  :      <input type="text" size="20" maxlength="40" name="name"><br/><br/>
  Password	:	<input type="password" size="20" maxlength="20" name="pass1"><br/><br/>
