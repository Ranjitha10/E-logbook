      ...
      <div class="inverted secondary pointing ui menu">
        ...
        <div class="right menu">
         <a class="item" href="faculty_menu.php">Home</a>
          ...
          <a class="item" href="facuty_report.php">Stats</a>
...
<div class="ui basic modal" id="each_student">
	...
	<?php
							...
							if(mysqli_num_rows($result) <= 0) {
								...
								echo " <table class='ui left aligned inverted five column celled table segment'><thead><tr><th>Name</th><th>USN</th><th>Semester</th><th>Phone</th><th>Parent</th><th>Address</th></tr></thead><tbody>";
							...
							$q="SELECT count(*) as total from student";
