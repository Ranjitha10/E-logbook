        ...
        <div class="box">
         ...
         <!-- <li><a href="checkstatus.php">Check Lab status</a></li>-->
          ...
          <li><a href="dashboard.php"> Marks Statistics</a></li>
            <li><a href="checkstatus.php">Check Lab status</a></li>
            <li><a href="facultylogout.php">Log out</a></li></p>
          </ul>
        </div>
      </div>
...
<div class="right_section">
      <div class="navigation" id="fsignup">
        ...
        <hr>
        <p>
          <form action="studentmessage1.php" method="POST">
           Enter Message: <br/><textarea name="message" rows="12" cols="60" id="message">
            </textarea> <br/>
           <!--Enter Date:<input type="text" name="date" class="textfield"><br/>-->
